      ...
      <div className="flex items-center justify-center h-[100vh]">
        ...
        >
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <select crequired
                  ...
                  name="category"
                  id="category"
                  placeholder="Enter the complain category"
                  className="bg-transparent px-2 py-1 border" value={userInput.category}
                  onChange={handleUserInput}>
                  <option className="text-black bg-transparent" value=" ">Select Category</option>

                  <option className="text-black bg-transparent" value="Administrative">Administrative</option>
                  <option  className="text-black bg-transparent" value="Academic" selected>Academic</option>
                </select>
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  name="description"
                  id="description"
                  placeholder="Enter the complain description"
          ...
          <button
            ...
            type="submit"
          >
            {!initialCourseData.newCourse ? "Update Course" : "Create Complain"}
          </button>
        </form>
      </div>
    </Layout>
