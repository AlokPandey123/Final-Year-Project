...
const AdminDashboard = () => {
  ...
  const allUsersCount = 4;
  const subscribedUsersCount = 2;
  ...
  const userData = {
    labels: ["User Complains", "Solve Complain"],
    datasets: [
      {
        label: "User Details",
  ...
  const handleCourseDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete the complain?")) {
  ...
  const MyUserData = useSelector((state) => state?.auth?.data);
  ...
  return (
    <Layout>
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md shadow-md">
                <div className="flex flex-col items-center">
                  <p className="font-semibold">Registered Complains</p>
        ...
        {/* CRUD complain section */}
        <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-center text-3xl font-semibold">
              Create Complain Card
            </h1>
          ...
          <table className="table overflow-x-scroll">
            <thead>
              <tr>
                ...
                <th>Authentic User</th>
                <th>Total Avidances</th>
            ...
            <tbody >
              {myCourses?.map((element, index) => {
                if (MyUserData.fullName == element?.createdBy) {
                  return (
                    <tr key={element?._id}>
                      <td>{index + 1}</td>
                      <td>
        ...
        {/* For Checking Status on Complain */}
        <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-center text-3xl font-semibold">
              Complain Status
