...
export const addCourseLecture = createAsyncThunk(
  ...
  async (data) => {
    ...
    try {
      ...
      toast.promise(res, {
        loading: "Adding the Avidance...",
        success: "Avidance added successfully",
        error: "Failed to add Avidance",
      });
...
export const deleteCourseLecture = createAsyncThunk(
  ...
  async (data) => {
    ...
    try {
      ...
      toast.promise(res, {
        loading: "Deleting the Avidance...",
        success: "Avidance deleted successfully",
        error: "Failed to delete Avidance",
      });
