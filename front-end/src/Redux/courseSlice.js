...
export const getAllCourses = createAsyncThunk("/course/get", async () => {
  try {
    ...
    toast.promise(res, {
      loading: "Loading complain data...",
      success: "complain loaded successfully",
      error: "Failed to get complain",
    });
...
export const createNewCourse = createAsyncThunk(
  ...
  async (data) => {
    try {
      ...
      toast.promise(res, {
        loading: "Creating the complain...",
        success: "complain created successfully",
...
export const updateCourse = createAsyncThunk("/course/update", async (data) => {
  try {
    ...
    toast.promise(res, {
      loading: "Updating the complain...",
      success: "complain updated successfully",
